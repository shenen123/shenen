...
import com.liubinrui.model.dto.question.QuestionAddRequest;
import com.liubinrui.model.dto.question.QuestionEditRequest;
import com.liubinrui.model.dto.question.QuestionQueryRequest;
import com.liubinrui.model.dto.question.QuestionUpdateRequest;
...
public class QuestionController {
    ...
    public BaseResponse<Boolean> deleteQuestion(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!oldQuestion.getUserId().equals(user.getId()) && !userService.isAdminRequest(request)) {
    ...
    public BaseResponse<Boolean> updateQuestion(@RequestBody QuestionUpdateRequest questionUpdateRequest) {
        ...
        log.info("刘斌瑞3+",question.getOptions());
        // 数据校验
    ...
    public BaseResponse<QuestionVO> getQuestionVOById(long id, HttpServletRequest request) {
        ...
        log.info("题目:{}"+question.getOptions());
